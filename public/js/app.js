...
var orderPlaced = document.getElementById('order-placed');
if (orderPlaced) {
  orderPlaced.addEventListener('click', function () {
    ...
    fetchUserWalletBalance('useId').then(function (walletBalance) {
      var totalPrice = req.session.cart.totalPrice; // Replace this with your actual logic to calculate the total order price
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkcafeeats"] = self["webpackChunkcafeeats"] || [];
